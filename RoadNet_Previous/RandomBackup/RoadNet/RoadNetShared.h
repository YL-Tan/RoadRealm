 ...
 */
vector<vec2> FindNeighbors(const vec2 &startingPoint, int dist) {
 ...
 * @return Vec2 Point
 */
vec2 GetRandomPoint(int numOfRndValues = NUM_OF_RND_VAL, int radiusLimit = 0,const vec2 &originPoint = {}) {
